...
function Book(props) {
  return (
    <div className="card" style={{ width:"250px", backgroundColor: "#fff", margin: "20px", display: "flex", flexDirection: "column", borderRadius: "10px", boxShadow: "0 4px 8px rgba(0,0,0,0.5)", transition:"trasform 0.2s", height:"400px", overflow:"hidden"}}>
